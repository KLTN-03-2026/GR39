  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 font-headline">Đăng nhập</h1>
        <p className="mt-1 text-sm text-slate-500">Chào mừng bạn trở lại PhoneMarket</p>
      </div>

      <div className="rounded-3xl border border-purple-100 bg-white p-8 shadow-sm">
        <button
          onClick={handleGoogleLogin}
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-purple-100 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-primary-light hover:border-primary/20 transition-colors"
        >
